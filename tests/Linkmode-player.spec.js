...
const content = page
  .locator('div')
  .filter({ hasText: /^00:01:0900:00:00Smartcontent_newsshort_dw_clean12\.01\.26 19\.01 - 21\.01$/ })
  .first();
...
const linkmode = page.locator('.info_box.box13 > .info_box_container > .link-mode');
